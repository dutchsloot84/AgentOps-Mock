...
from google.cloud import aiplatform_v1  # GAPIC
...
def search_topk(query: str, top_k: int = TOP_K) -> List[Dict]:
    ...
    dp = aiplatform_v1.IndexDatapoint(datapoint_id="query", feature_vector=vector)
    q = aiplatform_v1.FindNeighborsRequest.Query(datapoint=dp, neighbor_count=top_k)
